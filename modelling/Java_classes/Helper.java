...
public class Helper {
	...
	/*	Ticket t1 = LoeseTicket.getTicket();
		...
		*/
		...
		Abo a1 = AboHandling.aboAbschlieﬂen("LarsWiebach", "1234");
		Thread.sleep(1000);
		Abo a2 = AboHandling.aboAbschlieﬂen("hans raderrscheid", "siebenAuge93");
		Thread.sleep(1000);
		Abo a3 = AboHandling.aboAbschlieﬂen("felix b¸chner", "kopfnuss1");
		Thread.sleep(1000);
		Abo a4 = AboHandling.aboAbschlieﬂen("michael klein", "234123");
		Thread.sleep(1000);
		Abo a5 = AboHandling.aboAbschlieﬂen("Feser Max", "rini786");
		Thread.sleep(1000);
		AboHandling.aboKuendingen(a2);
		Thread.sleep(1000);
		
		Abo a6 = AboHandling.aboAbschlieﬂen("domian haderfeld", "dodo2");
